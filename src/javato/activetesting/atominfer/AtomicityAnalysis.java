...
public class AtomicityAnalysis extends AnalysisImpl {
    ...
    private Map<String, UniqueEvent> threadMap;
	...
	synchronized (ActiveChecker.lock) {
	    ...
	    threadMap = new HashMap<String, UniqueEvent>();
    ...
    private void updateSequentialRelation(Integer iid, String thread, UniqueEvent e) {
     ...
     */
    private void markBlocksAsNonAtomic(Integer iid, String thread) {
